    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            while (cursor != null) {
                ...
                String longtitudeFromDatabase = cursor.getString(longitudeIx);

                names.add(nameFromDatabase);

                Double latitude = Double.parseDouble(latitudeFromDatabase);
                Double longitude = Double.parseDouble(longtitudeFromDatabase);

                LatLng locationFromDatabase = new LatLng(latitude, longitude);
